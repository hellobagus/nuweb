...
export const newsData: NewsItem[] = [
  {
    ...
    <p>Dalam pelatihan tersebut, para peserta mendapatkan materi tentang dasar-dasar kewirausahaan, manajemen usaha, pemasaran produk, dan keuangan syariah. Selain itu, peserta juga mendapat kesempatan untuk praktik langsung membuat produk-produk yang bernilai ekonomi.</p>
    
    <p>"Kami berharap setelah mengikuti pelatihan ini, para peserta dapat mengembangkan usaha mereka sendiri dan menerapkan ilmu yang telah didapat," tambah Hj. Siti Masruroh.</p>
    ...
    image: 'https://images.pexels.com/photos/6953806/pexels-photo-6953806.jpeg',
    tags: ['Ekonomi', 'Pemberdayaan', 'Wirausaha', 'Perempuan']
  },
  {
    id: '2',
    title: 'Mengenal Makna Puasa Syawal dan Keutamaannya',
    excerpt: 'Puasa Syawal memiliki keutamaan yang istimewa bagi umat Islam. Menjalankan puasa 6 hari di bulan Syawal seperti berpuasa sepanjang tahun.',
    content: `<p>Bulan Syawal merupakan bulan yang istimewa bagi umat Islam. Setelah sebulan penuh menjalankan ibadah puasa di bulan Ramadhan, Allah SWT masih memberikan kesempatan kepada kita untuk meningkatkan amal ibadah melalui puasa Syawal.</p>

    <p>Puasa Syawal adalah puasa sunnah yang dilaksanakan selama 6 hari di bulan Syawal setelah Idul Fitri. Berdasarkan hadits Nabi Muhammad SAW, barangsiapa yang berpuasa Ramadhan kemudian melanjutkannya dengan puasa 6 hari di bulan Syawal, maka pahalanya seperti berpuasa sepanjang tahun.</p>
    
    <p>Dari Abu Ayyub Al-Anshari radhiyallahu 'anhu, Rasulullah shallallahu 'alaihi wa sallam bersabda:</p>
    
    <blockquote>"Barangsiapa berpuasa Ramadhan kemudian diikuti dengan puasa enam hari di bulan Syawal, maka itu seperti puasa sepanjang tahun." (HR. Muslim)</blockquote>
    
    <h3>Keutamaan Puasa Syawal</h3>
    
    <p>Berikut beberapa keutamaan puasa Syawal:</p>
    
    <ol>
      <li>Pahalanya seperti puasa setahun penuh</li>
      <li>Menunjukkan rasa syukur kepada Allah SWT</li>
      <li>Menutup kekurangan puasa Ramadhan</li>
      <li>Membiasakan diri untuk istiqomah dalam beribadah</li>
    </ol>
    
    <h3>Tata Cara Pelaksanaan</h3>
    
    <p>Puasa Syawal dapat dilaksanakan dengan beberapa cara:</p>
    
    <ul>
      <li>Enam hari berturut-turut setelah Idul Fitri</li>
      <li>Dilaksanakan secara terpisah selama bulan Syawal</li>
    ...
    image: 'https://images.pexels.com/photos/5468989/pexels-photo-5468989.jpeg',
    tags: ['Puasa', 'Syawal', 'Ibadah', 'Keagamaan']
  },
  {
    id: '3',
    ...
    <p>Kegiatan bakti sosial ini mendapat sambutan hangat dari masyarakat sekitar dan diharapkan dapat menjadi inspirasi bagi organisasi lain untuk melakukan hal serupa.</p>
    ...
    tags: ['Bakti Sosial', 'Panti Asuhan', 'Kegiatan Sosial']
  },
  {
    id: '4',
    ...
    <p>Selain itu, beliau juga mengungkapkan bahwa Islam sangat menghargai dan memuliakan perempuan. "Banyak contoh perempuan hebat dalam sejarah Islam yang bisa menjadi inspirasi bagi kita semua," tambahnya.</p>
    
    <p>Seminar ini juga menghadirkan sesi diskusi panel dengan tema "Perempuan dalam Perspektif Islam dan Kontribusinya di Era Modern". Dalam sesi tersebut, dibahas tentang bagaimana perempuan dapat berkontribusi secara optimal dalam berbagai bidang tanpa meninggalkan nilai-nilai keislaman.</p>
    
    <p>Di akhir acara, diadakan peluncuran buku berjudul "Kartini-Kartini NU: Kisah Inspiratif Perempuan Pesantren" yang berisi kumpulan kisah perempuan NU yang telah memberikan kontribusi besar dalam berbagai bidang.</p>
    
    <p>"Semoga acara ini dapat menjadi inspirasi bagi seluruh perempuan Indonesia untuk terus berkarya dan berkontribusi bagi agama, bangsa, dan negara," tutup Hj. Siti Masruroh.</p>`,
    category: 'Pendidikan',
    date: '2023-04-21',
    author: 'Hj. Siti Masruroh',
    image: 'https://images.pexels.com/photos/7516363/pexels-photo-7516363.jpeg',
    tags: ['Hari Kartini', 'Kepemimpinan', 'Seminar', 'Perempuan']
  },
  {
    id: '5',
    ...
    <p>Program "Ummahat Hafiz" akan dilaksanakan dua kali seminggu, yaitu setiap hari Selasa dan Jumat pagi. Para peserta akan dibagi menjadi beberapa kelompok kecil yang masing-masing didampingi oleh seorang hafizah yang berpengalaman.</p>
    ...
    <p>Program ini mendapat sambutan antusias dari para ibu rumah tangga. Terbukti dengan terdaftarnya 75 peserta pada hari peluncuran, melebihi target awal yang hanya 50 peserta.</p>
    ...
    image: 'https://images.pexels.com/photos/5273076/pexels-photo-5273076.jpeg',
    tags: ['Al-Quran', 'Hafalan', 'Ibu Rumah Tangga', 'Program Keagamaan']
  },
  {
    id: '6',
    ...
    <p>Workshop ini menghadirkan beberapa narasumber, di antaranya Dr. Ir. Hj. Siti Aminah, M.Si, pakar teknologi pangan dari Universitas Diponegoro, dan Chef Farah Quinn, yang dikenal sebagai celebrity chef dengan keahlian dalam masakan Nusantara.</p>
    
    <p>Dalam sesi pertama, Dr. Ir. Hj. Siti Aminah menjelaskan tentang pentingnya memahami sertifikasi halal dan bahan-bahan makanan yang perlu diwaspadai. "Tidak semua bahan makanan yang tersedia di pasaran itu halal. Kita perlu cermat dalam memilih bahan makanan," jelasnya.</p>
    
    <p>Sementara itu, Chef Farah Quinn membagikan tips dan trik dalam mengolah makanan yang lezat namun tetap sehat. Dia juga memperkenalkan beberapa resep makanan sehat yang mudah dibuat untuk keluarga.</p>
    ...
    <p>Di akhir acara, Hj. Fatimah Zuhro menyampaikan harapannya agar peserta workshop dapat menerapkan ilmu yang didapat dalam kehidupan sehari-hari dan juga membagikannya kepada masyarakat sekitar.</p>
    
    <p>"Semoga workshop ini tidak hanya bermanfaat bagi peserta, tetapi juga bagi masyarakat luas melalui peran peserta sebagai agen perubahan," tutupnya.</p>`,
    category: 'Kesehatan',
    date: '2023-08-12',
    author: 'Hj. Fatimah Zuhro',
    image: 'https://images.pexels.com/photos/3184192/pexels-photo-3184192.jpeg',
    tags: ['Makanan Halal', 'Kesehatan', 'Workshop', 'Kuliner']
  }
];
...
export const getRecentNews = (count: number = 3): NewsItem[] => {
  // Sort by date (descending) and take the first 'count' items
  return [...newsData]
